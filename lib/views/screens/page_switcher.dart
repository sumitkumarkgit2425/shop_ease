...
import 'package:shop_ease/views/screens/home_page.dart';
import 'package:shop_ease/views/screens/notification_page.dart';
import 'package:shop_ease/views/screens/profile_page.dart';
...
class _PageSwitcherState extends State<PageSwitcher> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: [HomePage(), NotificationPage(), ProfilePage()][_selectedIndex],
