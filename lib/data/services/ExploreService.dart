import '../models/ExploreItem.dart';
import '../models/ExploreUpdate.dart';

class ExploreService {
  static List<ExploreItem> listExploreItem = listExploreItemRawData
      .map((data) => ExploreItem.fromJson(data))
      .toList();
