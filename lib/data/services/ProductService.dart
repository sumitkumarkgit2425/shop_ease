...
class ProductService {
  static List<Product> productData = productRawData
      .map((data) => Product.fromJson(data))
      .toList();
  static List<Product> searchedProductData = searchedProductRawData
      .map((data) => Product.fromJson(data))
      .toList();
}
...
var productRawData = [
  {
    'image': ['assets/images/nikeblack.jpg', 'assets/images/nikegrey.jpg'],
    ...
    'colors': [
      ...
      {'name': 'blueGrey', 'color': Colors.blueGrey[200]},
      {'name': 'pink', 'color': Colors.pink[100]},
  ...
  // 2
  {
    'image': ['assets/images/nikegrey.jpg', 'assets/images/nikeblack.jpg'],
  ...
  // 3
  {
    'image': ['assets/images/nikehoodie.jpg', 'assets/images/nikeblack.jpg'],
  ...
  // 4
  {
    'image': ['assets/images/adidasjacket.jpg', 'assets/images/nikeblack.jpg'],
